export default {
  ...
  knowledgeBase: {
    ...
    image: {
      uploadTitle: "上传图片",
      uploadHint: "支持 JPG/PNG/GIF/WebP/BMP 格式，单张 ≤ 20MB",
      dropHint: "将图片拖拽到此区域或点击上传",
      selectFile: "选择文件",
      uploading: "上传中...",
      uploadSuccess: "图片上传成功",
      uploadFailed: "图片上传失败",
      processing: "处理中",
      deleteConfirm: "确认删除此图片？",
      deleteSuccess: "图片已删除",
      noImages: "暂无图片",
      noImagesDesc: "上传图片开始构建图片知识库",
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      typeFAQ: "问答",
      typeImage: "图片",
      typeDescription: "FAQ 类型适合结构化问答数据；文档型支持文件解析与分块；图片库支持单图上传、OCR 识别与以图搜图；Wiki 类型由 LLM 自动构建互链知识页面。",
      typeImageDescription: "图片库通过 VLM 模型自动识别图片文字（OCR）并生成图片描述，支持以文搜图和以图搜图。",
      imageUploadHint: "支持 JPG/PNG/GIF/WebP/BMP 格式，单张 ≤ 20MB",
      imageVlmRequired: "图片库需要配置 VLM 模型和 Embedding 模型",
      imageVlmNotEnabled: "图片库必须启用 VLM 模型（请在模型配置中选择 VLM 模型并启用）",
      imageEmbeddingRequired: "图片库必须绑定 Embedding 模型",
      nameLabel: "知识库名称",
    ...
    image: {
      title: "图片",
      subtitle: "上传图片自动进行 OCR 文字识别和内容描述生成，支持以文搜图和以图搜图",
    },
    faq: {
      title: "问答",
  ...
  admin: {
    dashboard: {
      title: "系统概览",
      subtitle: "查看系统运行状态和资源使用情况",
      totalTenants: "总租户数",
      active: "活跃",
      totalUsers: "总用户数",
      totalKnowledgeBases: "总知识库数",
      totalStorage: "总存储使用",
      totalTokenUsage: "总 Token 使用量",
      trials: "试用租户",
      converted: "已转化",
      tenantUsageRanking: "租户用量排行",
      viewAll: "查看全部",
      loadFailed: "加载统计数据失败",
    },
    tenants: {
    ...
    plans: {
      ...
      inactive: "未启用",
      maxUsers: "最大用户数",
      maxKnowledgeBases: "最大知识库数",
      maxAgents: "最大智能体数",
      storageQuota: "存储配额",
      tokenQuotaMonthly: "月 Token 配额",
      unlimited: "不限",
      sortOrder: "排序",
      quotaSettings: "配额设置",
      empty: "暂无套餐配置",
