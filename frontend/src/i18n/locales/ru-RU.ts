export default {
  ...
  knowledgeBase: {
    ...
    image: {
      ...
      uploadHint: 'Поддерживаются JPG/PNG/GIF/WebP/BMP, до 20MB на файл',
      dropHint: 'Перетащите изображения сюда или нажмите для загрузки',
      ...
      noImagesDesc: 'Загрузите изображения, чтобы создать базу знаний изображений',
      fileTooLarge: 'Размер файла не может превышать 20MB',
...
/example\.(net|org)/`,
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      typeDescription: 'FAQ подходит для структурированных Q&A; документальный тип поддерживает загрузку файлов и разбиение; библиотека изображений поддерживает OCR и обратный поиск изображений; Wiki автоматически создает связанные страницы знаний через LLM.',
      typeImageDescription: 'Библиотека изображений использует VLM для автоматического распознавания текста (OCR) и генерации описаний, обеспечивая поиск текст-изображение и изображение-изображение.',
      imageUploadHint: 'Поддерживаются форматы JPG/PNG/GIF/WebP/BMP, до 20MB на файл',
      imageVlmRequired: 'Для библиотеки изображений требуется модель VLM и модель Embedding',
      imageVlmNotEnabled: 'Для библиотеки изображений необходимо включить модель VLM (выберите модель VLM в настройках)',
      imageEmbeddingRequired: 'Для библиотеки изображений требуется модель Embedding',
    ...
    image: {
      ...
      subtitle: 'Загружайте изображения для автоматического распознавания текста (OCR) и генерации описаний, с поддержкой поиска текст-изображение и изображение-изображение'
    },
    faq: {
      title: 'Настройки FAQ',
